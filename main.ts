...
import { Iprepare } from "./models/preper.model";
//#endregion

//#region varibile declarsation 
const preper: Iprepare = {}
...
const selected = (card: Icard , index: number) => {
...
const progress = () => {
  const progress = preper.cards.filter(card => !card.clickable).length / numOfCards * 100;
        ...
        <div onclick="toggleFlip(${index})" class="card-flip">
            <div id="card-flip-${index}">
                ...
                <div class="back">
                    <!-- back content -->
                    <div class="card">
                        <img src="./asset/images/${item.index}.jpg" alt="Image [100%x180]" data-holder-rendered="true"
